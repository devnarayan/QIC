...
namespace QIC.Areas.Admin.Controllers
{
    public class LanguageController : Controller
    {
        ...
        public ActionResult Create([Bind(Include="LanguageID,Lang,LangShort")] Language language)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include="LanguageID,Lang,LangShort")] Language language)
        {
            if (ModelState.IsValid)
            {
