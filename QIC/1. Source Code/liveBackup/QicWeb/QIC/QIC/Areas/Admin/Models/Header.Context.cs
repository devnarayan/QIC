...
namespace QIC.Areas.Admin.Models
{
    ...
    public partial class QICdbEntities2 : DbContext
    {
        ...
        public virtual ObjectResult<spGetLanguage_Result> spGetLanguage()
        {
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<spGetLanguage_Result>("spGetLanguage");
        }
    }
}
